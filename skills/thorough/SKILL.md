...
After answers, re-check all 6 axes. If gaps remain, call `AskUserQuestion` again. Repeat until all axes are clear, then proceed to Phase 3.

## Phase 3 — Feasibility

Check for technical impossibility, scope mismatches, dependency risks, conflicting constraints. Surface any concerns with options. If none, proceed to Phase 4.
